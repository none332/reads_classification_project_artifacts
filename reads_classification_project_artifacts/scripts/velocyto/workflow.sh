...
#   $1 = work directory
#   $2 = input BAM filename pattern
#   $3 = velocyto directory
#   $4 = reference GTF
#   $5 = repeat mask GTF
#   $6 = fake CB/UB tagging script
#   $7 = python directory
...
bam_pattern="${2:-SRR*_mapQ30.bam}"

velo="${3:-velocyto}"
ref_gtf="${4:-${project_root}/data/short_read/references/gencode_mm39.gtf}"
rmsk_gtf="${5:-${project_root}/data/short_read/references/mm39_rmsk.gtf}"
add_tag_script="${6:-${script_dir}/process_fakecbub.py}"
python_bin="${7:-python}"
